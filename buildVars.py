...
addon_info = AddonInfo(
	...
	addon_description=_(
		...
		It also allows to customize the information reported on a character when using review cursor character """
...
pythonSources: list[str] = [os.path.join('addon', 'globalPlugins', 'charInfo', '*.py')]
